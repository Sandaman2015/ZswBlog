      ...
      <ul>
        <li v-for="(item,index) in commentsList">
          <div class="main-reply">
            <div class="user-info">
              <!-- 图片的路径 -->
              <img :src="item.commentParent.userPortrait" alt="头像" class="userImage" />
              <p class="info">
                <!-- 用户名 -->
                <a href="javascript:void(0)" class="name white">{{item.commentParent.userName}}</a>
              </p>
              <div class="comment" v-html="item.commentParent.comment"></div>
              <div class="more">
                <p class="date">
                  <i class="fa fa-calendar-o" aria-hidden="true"></i>
                  {{item.commentParent.commentDate|subTDate}}
                </p>
                <p class="location">
                  <i class="fa fa-location-arrow" aria-hidden="true"></i>
                  {{item.commentParent.location}}
                </p>
                <p class="browser">
                  <i class="fa fa-chrome" aria-hidden="true"></i>
                  {{item.commentParent.browser}}
                </p>
                <p class="submit">
            ...
            <div v-bind:class="{'editor-reply':true,'hide':true }">
              <form class="form">
                ...
                <div class="submit">
                  ...
                  <span hidden>{{item.commentParent.userId}}</span>
                  <span hidden>{{item.commentParent.commentId}}</span>
                </div>
              </form>
            </div>
          </div>
          <div class="all-reply">
            <div class="reply-list" v-for="(replyEntry,replyIndex) in item.commentChildren">
              <div class="user-info">
                ...
                <div class="comment sec-coment" v-html="replyEntry.comment"></div>
                <div class="more">
                  <p class="date">
                    <i class="fa fa-calendar-o" aria-hidden="true"></i>
                    {{replyEntry.commentDate|subTDate}}
                  </p>
                  <p class="location">
                    <i class="fa fa-location-arrow" aria-hidden="true"></i>
                    {{replyEntry.location}}
              ...
              <div v-bind:class="{'editor-reply':true,'hide':isShow}">
                <form class="form">
                  ...
                  <div class="submit">
                    ...
                    <span hidden>{{replyEntry.commentId}}</span>
                  </div>
                </form>
              </div>
            </div>
...
import { addComment } from "../../../static/js/api/comment.api";
