<template>
  <aside>
    <div class="background">
      ...
      <div class="descriptionWrapper" style="z-index:9">
        <div class="temperatureWrapper">{{temperature}}</div>
...
<script>
import { getLocation } from "../../static/js/api/message.api";
export default {
  data() {
    return {
      city: "合肥",
  ...
  methods: {
    async init() {
      ...
      await this.$jsonp(url)
        ...
        .then(() => {
          getLocation(ip).then(e => {
            if (JSON.stringify(e).indexOf("市") !== -1) {
              this.city = e;
            } else {
              this.$message({
                message: "当前定位失败，已为您定位到北京！",
                type: "error"
              });
              this.city = "北京";
            }
      ...
      let urlCity = `https://bird.ioliu.cn/weather?city=${this.city}`;
      await this.$jsonp(urlCity).then(e => {
        let data = JSON.parse(e);
        this.temperature = data.now.tmp + "℃";
        this.info = data.now.cond.txt;
      });
    }
  }
};
...
.small-2 {
  ...
  width: 4px;
  height: 4px;
  animation: drop 2.1s linear 0.28s infinite;
  animation-fill-mode: both;
}
.small-2:before {
  top: -2px;
...
.medium-3 {
  ...
  width: 6px;
  height: 6px;
  animation: drop 1.5s linear 1.8s infinite;
  animation-fill-mode: both;
}
.medium-3:before {
  top: -2px;
...
.medium-4 {
  ...
  width: 6px;
  height: 6px;
  animation: drop 1.4s linear 1.84s infinite;
  animation-fill-mode: both;
}
.medium-4:before {
  top: -2px;
...
.small-4 {
  ...
  width: 4px;
  height: 4px;
  animation: drop 2.1s linear 0.72s infinite;
  animation-fill-mode: both;
}
.small-4:before {
  top: -2px;
...
.medium-6 {
  ...
  width: 6px;
  height: 6px;
  animation: drop 1.5s linear 0.08s infinite;
  animation-fill-mode: both;
}
.medium-6:before {
  top: -2px;
...
.small-6 {
  ...
  width: 4px;
  height: 4px;
  animation: drop 2.1s linear 1.72s infinite;
  animation-fill-mode: both;
}
.small-6:before {
  top: -2px;
...
.big-7 {
  ...
  border-radius: 50%;
  background-color: #7fc1f9;
  animation: drop 0.95s linear 1.76s infinite;
  animation-fill-mode: both;
  transform-origin: 50% 100%;
}
.big-7:before {
...
.medium-7 {
  ...
  width: 6px;
  height: 6px;
  animation: drop 1.4s linear 0.88s infinite;
  animation-fill-mode: both;
}
.medium-7:before {
  top: -2px;
...
.medium-8 {
  ...
  width: 6px;
  height: 6px;
  animation: drop 1.5s linear 0.56s infinite;
  animation-fill-mode: both;
}
.medium-8:before {
  top: -2px;
...
.small-8 {
  ...
  width: 4px;
  height: 4px;
  animation: drop 2.1s linear 1.16s infinite;
  animation-fill-mode: both;
}
.small-8:before {
  top: -2px;
...
.small-9 {
  ...
  width: 4px;
  height: 4px;
  animation: drop 2s linear 0.28s infinite;
  animation-fill-mode: both;
}
.small-9:before {
  top: -2px;
...
.big-10 {
  ...
  border-radius: 50%;
  background-color: #7fc1f9;
  animation: drop 0.95s linear 0.96s infinite;
  animation-fill-mode: both;
  transform-origin: 50% 100%;
}
.big-10:before {
